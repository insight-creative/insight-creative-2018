...
gulp.task('watch', function() {
    ...
    gulp.watch(['*.html', '_layouts/*.html', '_posts/*', 'work/*.html', 'services/*.html', 'culture/*.html', 'blog/*.html', 'contact/*.html', 'about/*.html', 'blog/**/*.md', 'work/**/*.md', 'play/**/*.html', 'play/**/*.md', 'bash/**/*.html'], ['jekyll-rebuild']);
});
